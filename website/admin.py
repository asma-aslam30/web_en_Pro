...
from .forms import ShopItems
from . import db


admin = Blueprint('admin',__name__)

@admin.route('/media/<path:filename>') # it will allow us to pick filename from URL
...
def add_items():
    ...
    return render_template('404.html') # b/c id == 5 is admin
